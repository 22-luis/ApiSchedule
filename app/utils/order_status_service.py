...
class OrderStatusService:
    ...
    def update_order_status_for_task_completion(db: Session, programming_task: ProgrammingTask) -> None:
        ...
        El estado se basa en missing_quantity, no en la completación de tareas.
        """
        ...
        try:
            ...
            # El estado se determina por missing_quantity, no por completación de tareas
            # Este método se mantiene para compatibilidad pero no cambia estados automáticamente
            pass
        except (ValueError, TypeError):
            # Si el lote no es un número válido, no hacer nada
            pass
